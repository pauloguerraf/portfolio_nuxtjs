...
<div class="w-full min-h-screen bg-white">
  ...
  <div class="md:text-3xl text-2xl lg:px-40 md:px-36 px-20">
    ...
    <div id="history" class="grid md:grid-cols-3 grid-cols-1 text-myblue">
      <div class="md:py-16 py-8 text-xl md:px-8 px-4 border-b md:border-b-0 z-10">
      ...
      <div class="md:py-16 py-8 text-xl md:px-8 px-4 border-b md:border-b-0 md:border-l md:border-r z-10">
      ...
      <div class="md:py-16 py-8 text-xl md:px-8 px-4 z-10">
