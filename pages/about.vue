...
<div class="w-full min-h-screen bg-white">
  ...
  <div class="md:text-4xl text-3xl lg:px-40 md:px-36 px-20">
    ...
    <div id="intro" class="w-full py-12 lg:flex md:px-6 items-center z-10">
      ...
      Hi, my name is Paulo. I am a <strong>creative developer</strong> passionate about exploring <strong>cutting edge</strong> technology-enabled <strong>interactions</strong> and connecting people through <strong>meaningful</strong> and innovative <strong>experiences</strong>.
      </div>
    </div>
